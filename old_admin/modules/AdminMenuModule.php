...
$AdminMenu.='
<li><a href="javascript:void(0);">'.AIco(22).'Достопримечательности</a><ul>
	<li><a href="?cat=adm_placeslist">'.AIco(27).'Список мест</a></li>
	<li><a href="?cat=adm_placescats">'.AIco(40).'Категории мест</a></li>
	<li><a href="?cat=adm_placesxml">'.AIco(45).'XML выгрузка мест</a></li>
</ul></li>'; 	
