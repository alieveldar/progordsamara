...
if ($state != 1)
	...
	while($Worker_Meetings_Rows = mysql_fetch_array($Worker_Meetings_Sql))
		...
		echo "<tr id=\"hrow".$Worker_Meetings_Rows['mid']."\"><td>".$Worker_Meetings_Rows['mdate']."</td><td>".$Worker_Meetings_Rows['mname']."</td><td width='149px'>".$Worker_Meetings_Rows['p']." <div id=\"showmeetcomment\"><span style=\"font-size:11px;\">".$pcom."</span></div></td><td width='149px'>".$Worker_Meetings_Rows['f']." <div id=\"showmeetcomment\"><span style=\"font-size:11px;\">".$fcom."</span></div></td><td><a href=\"#edit\" class=\"\" onclick=\"editmeetingmodal(".$Worker_Meetings_Rows['mid'].")\"><img width=\"17px\" src=\"/img/edit.png\" alt=\"Редактировать\" title=\"Редактировать\"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"#delete\" onclick=\"deletemeetmodal(".$Worker_Meetings_Rows['mid'].",'".$Meet_Info."');\"><img width=\"17px\" src=\"/img/delete.png\" alt=\"Удалить\" title=\"Удалить\"></a></td></tr>";
		}
