...
function GetWidgetYandex($file)
{
    ...
    for ($i = 0; $i < $data["total"]; $i++): @mysql_data_seek(
      ...
      $i
        ...
        $path = "http://prokazan.ru/".$ar["link"]."/view/".$ar["id"];
        if ($ar["pic"] != '') {
            $pic = "<img src='http://prokazan.ru/userfiles/picsquare/$ar[pic]' title='Новости Казани: ".$ar["name"]."' alt='Новости Казани: ".$ar["name"]."' />";
        } else {
            $pic = '';
        }
...
<head>
    ...
    <meta name="title" content="Новости Казани"/>
    <meta name="description"
          content="Новости города Казань, спортивные и авто новости Казани"/>
    <link rel="stylesheet" type="text/css" href="yandex.css" media="all">
    <script type="text/javascript"
            src="http://img.yandex.net/webwidgets/1/WidgetApi.js"></script>
</head>
<body>
<div id="NewsLenta"><? echo $val; ?></div>
<script type="text/javascript">widget.onload = function () {
