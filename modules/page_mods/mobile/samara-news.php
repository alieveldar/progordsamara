<?
$pg = $dir[1] ? $dir[1] : 1;
$file = "_index-samaranews_".(int)$pg;
$VARS["cachepages"] = 0;
$Page["Caption"] = "Новости Самары";
$CSSmodules["авто включение ленты"] = "/modules/lenta/mobile.lenta.css";
...
function KazanNews()
{
	...
	FROM `[table]` LEFT JOIN `_users` ON `_users`.`id`=`[table]`.`uid` WHERE (`[table]`.`stat`='1')";
