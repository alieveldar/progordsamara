<?
$file = "_bottomblock-new_default";
if (RetCache($file, "cacheblock") == "true") {
    list($Page["BottomContent"], $cap) = GetCache($file, 0);
} else {
    list($Page["BottomContent"], $cap) = CreateBottomBlock();
    SetCache($file, $Page["BottomContent"], "", "cacheblock");
}
...
{
    global $Domains, $SubDomain, $GLOBAL, $C20;
    $text = '';
    // --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
