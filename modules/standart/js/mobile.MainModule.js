...
function findOffsetHeight() {
    var e = document.getElementById("AllContent");
    var res = 0;
...
function BannersPodlogka(b) {
    ...
    if ($("#AllContent").size() > 0) {
        ...
        $("#AllContent").css("background", "url(/advert/files/image/" + b[5] + ") center top no-repeat");
        if (b[12] != "") {
            $("#AllContent").append("<div class='counter'><img src='" + b[12] + "' /></div>");
        }
    }
}
