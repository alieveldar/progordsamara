...
qq.FineUploaderBasic = function (o) {
    ...
    this._options = {
        ...
        autoUpload: true,
        request: {
            endpoint: '/modules/standart/multiupload/server/handler.php',
            params: {},
            paramsInBody: false,
            customHeaders: {},
            forceMultipart: true,
...
qq.FineUploader = function (o) {
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'Выберите файлы для загрузки',
            cancelButton: '<img src=/admin/images/icons/exit.png>',
            retryButton: 'Попытка',
            failUpload: 'Ошибка сервера',
            dragZone: 'Перетащите сюда файлы, чтобы начать загрузку',
            dropProcessing: 'Processing dropped files...',
            formatProgress: "Загружено: {percent}% из {total_size}",
            waitingForResponse: "Обработка изображения..."
        },
        ...
        retry: {
            ...
            autoRetryNote: "Попытка: {retryNum} из {maxAuto}...",
            showButton: false
        },
...
qq.extend(qq.FineUploader.prototype, {
    ...
    _controlFailureTextDisplay: function (item, response) {
        ...
        if (mode === 'custom') {
            ...
            qq(this._find(item, 'statusText')).setText(response.error);
        }
        else if (mode !== 'none') {
