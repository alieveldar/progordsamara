...
// === === === === === === === === === === === === === === === === === === === === === === === === === === === === === === 
function nlbr($text) { $text=str_replace(array("\t","\r","\n","&nbsp;", 'src="/userfiles'), array("","",""," ", 'src="http://progorodsamara.ru/userfiles'), $text); /*$text=htmlspecialchars($text, ENT_QUOTES);*/ return $text; } function GetMobileVideo($text) { $text=preg_replace('~width="\d+"~', 'width="100%"', $text); $text=preg_replace('~height="\d+"~', 'height="300px"', $text); return $text; } function ToRusData($var) { $var = date("Y.m.d.H.i.s", $var); list($y, $m, $d, $h, $i, $s)=explode(".", $var); $data=$h.":".$i.", ".$d.".".$m.".".$y; return($data); }
?>