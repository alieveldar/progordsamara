...
if ($link=="news" && (int)$dir[2]==180263) { @header("location: /usa-nuclear"); exit(); }
if ($link=="news" && (int)$dir[2]==183035) { @header("location: /cosmos"); exit(); }
if ($link=="sport" && (int)$dir[2]==148124) { @header("location: /cvvs"); exit(); }
...
if ($start=="view") {
	...
	$data=DB("SELECT `id`,`comments`, `promo`,`alttext` FROM `".$table."` WHERE (`id`='".(int)$dir[2]."' ".$where.") LIMIT 1");
	if ($data["total"]==1) {
...
//--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
} else { $text=$new["alttext"]; $cap=$new["name"]; $node["design"]="akbars"; $Page["Content"]=$text; $Page["Caption"]=$cap; }
//--- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- 
