...
if ($GLOBAL["sitekey"]==1 && $GLOBAL["database"]==1) {
	...
	/* строгий запрет */ $StopWords2=array("vredy.biz", "samarafishing", "самарфишинг", "геройский рыбак", "самарафишинг", "самарафиш", "Есаулу", "есаул", ".gd", ".ly", "vurl.com", "gu.ma", "fur.ly", "в сети появились", "в сети появилось", "долбоеб", "долбаеб", "долбаёб", "долбоёб", "в сети появилась", "Ловев", "мудер", "/smoke", "mic.fr", "100% работает", "Лосев", "смотреть любую информацию", "слили всю базу", "хуй", "пизда", "пиздой", "пидор", "хуйн","капли мужу", "капли для мужа", "мужу капли", "maaxim",);
