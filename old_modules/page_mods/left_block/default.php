...
function CreateLeftBlock() {
	...
	// --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
		...
		if ((int)$bubr["adv"]!=1) { $bubr["name"]=(string)$item->title; $bubr["link"]=(string)$item->link; $bubr["pic"]=(string)$item->picmiddle; $bubr["data"]=(string)$item->data; $bubr["lid"]=(string)$item->ttwo; $ar["style"]="Bubr"; $tmplist[]=$bubr; } $i++; endwhile; }
		...
		$text.="</div>".$C20;
		if ($cnt%4==0) { if ($ban10<10) { $text.="<div class='banner3' id='Banner-10-".$ban10."'></div>"; $ban10=$ban10+2; }} 
		$cnt++; }
