...
if ($link=="all") { $RealPage="all"; }
if ($link=="places") { $RealPage="places"; }
...
if ($node["link"]=="sf2016") { $design="sf2016";  }
if ($node["link"]=="places") { $design="places";  }
if ($node["link"]=="cosmos") { $design="cosmos";  }
...
$RENDER.=$DesignHtml.$r;
	...
	<a href='/economy/1'><img src='/template/standart/icons/kras.png' />Красота и здоровье".$C."</a>
...
$RENDER.='<input type="hidden" id="BoxCount" value="0" /><input type="hidden" id="gidvk" value="0" /><input type="hidden" id="DomainId" value="'.(int)$SubDomain.'" /><input type="hidden" id="UserId" value="'.(int)$_SESSION["userid"].'" />'; $RENDER.='</body>'.$r.'</html>';
