CKEDITOR.editorConfig=function(config) {
	...
	config.toolbar_Full=[
		...
		{ name: 'basicstyles',	items : [ 'Bold','Italic','Superscript']},{ name:'styles', items:['Styles']},
...
CKEDITOR.stylesSet.add('ProCms',[
	...
	{ name:'Twitter', element:'p', attributes:{'class':'totwitter', 'style':'border-top:1px solid #DDD; border-bottom:1px solid #DDD; padding:10px 0; font-weight:bold; '}},
