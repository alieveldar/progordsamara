...
// ВЫВОД ПОЛЕЙ И ФОРМ
  ...
  ### Основные данные
    ...
    <tr class="TRLine0 ShowSets"><td class="VarName">Время жизни коммерции</td><td class="LongInput"><div class="sdiv"><select name="life_days"><option value="1">1 день</option><option value="5">4 дня</option><option selected value="11">10 дней</option></select></div></td><tr>
    '."</table></div>";
