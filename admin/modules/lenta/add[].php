...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
        ...
        if (isset($P["savebutton"])) {
            ...
            $q = "INSERT INTO `".$alias."_lenta` (`uid`, `bid`, `cat`, `name`, `kw`, `ds`, `cens`, `realinfo`, `comments`, `data`, `astat`, `adata`, `promo`, `spromo`, `onind`, `spec`, `yarss`, `mailrss`, `tavto`, `tags`, `redak`,`gis`,`mailtizer`)
		...
		'".$P["autoon"]."', '".$sdata2."', '".$P["comrs"]."', '".$P["scomrs"]."','".$P["ontv"]."', '".$P["spec"]."', '".$P["yarss"]."', '".$P["mailrss"]."', '".$P["tavto"]."', '".$dtags."', '".$P["redak"]."', '".$P["gis"]."', '".$P["mailtizer"]."')";
