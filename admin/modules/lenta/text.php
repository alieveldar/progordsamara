...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if ($data["total"]!=1) { $AdminText=ATextReplace('ItemError', $raz["shortname"]." (".$alias.")", $id); $GLOBAL["error"]=1; } else {
		...
		<div class='LongInput' style='float:left; width:620px;'><textarea name='lid' id='lid' style='height:50px; font-size:11px; padding:4px;' maxlength='300'>".$node["lid"]."</textarea></div>
