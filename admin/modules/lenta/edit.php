...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
        ...
        if ($data["total"] != 1) {
            ...
            if ($advert_life_items["data"] == 1) {
                ...
                $a_l2 = "selected";
            } elseif ($advert_life_items["data"] == 11) {
                $a_l3 = "selected";
            }
            if(empty($a_l1) && empty($a_l2)) $a_l3 = "selected";
              ...
              $i
                ...
                for ($i = 0; $i < $data["total"]; $i++): @mysql_data_seek(
                  ...
                  $i
                    ...
                    <tr class="TRLine0 ShowSets"><td class="VarName">Время жизни коммерции</td><td class="LongInput"><div class="sdiv"><select name="life_days"><option value="1" '.$a_l1.'>1 день</option><option value="5" '.$a_l2.'>4 дня</option><option value="11" '.$a_l3.'>10 дней</option></select></div></td><tr>
                    '."</table></div>";
