...
if ($GLOBAL["sitekey"]==1 && $GLOBAL["database"]==1) {
	...
	ORDER BY ".$table3.".`data` DESC  LIMIT $from, $onpage"; $data=DB($q1); $q2="SELECT ".$table3.".id FROM ".$table3; $data2=DB($q2); $pager=Pager($pg, $onpage, ceil($data2["total"]/$onpage)); 
	
	$AdminText='<h2 style="float:left;">Статистика оплаты</h2>';
