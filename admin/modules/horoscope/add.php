...
// СОХРАНЕНИЕ ПОЛЕЙ И ФОРМ
	...
	if (isset($P["savebutton"])) {
		...
		$q="INSERT INTO `".$alias."_lenta` (`uid`, `domain`, `name`, `kw`, `ds`, `cens`, `realinfo`, `comments`, `data`, `astat`, `adata`, `promo`, `onind`, `spec`, `yarss`, `mailrss`, `tavto`, `tags`, `redak`,`gis`,`mailtizer`,`dzenrss`)
		VALUES ('".$_SESSION['userid']."', '".(int)$P["domain"]."', '".$P["dname"]."', '".$P["dkw"]."', '".$P["dds"]."', '".$P["cens"]."', '".$P["realinfo"]."', '".$P["comms"]."', '".$sdata1."',
		'".$P["autoon"]."', '".$sdata2."', '".$P["comrs"]."','".$P["ontv"]."', '".$P["spec"]."', '".$P["yarss"]."', '".$P["mailrss"]."', '".$P["tavto"]."', '".$dtags."', '".$P["redak"]."', '".$P["gis"]."', '".$P["mailtizer"]."','".$P["dzenrss"]."')";
