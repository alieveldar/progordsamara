CKEDITOR.editorConfig=function(config) {
	...
	config.toolbar_Full=[
		{ name: 'document',		items : [ 'Source','-','RemoveFormat','-','Undo','Redo','-', 'PasteText' ] },
		{ name: 'insert',		items : [ 'Link','Unlink','Table','SpecialChar' ] },
		{ name: 'basicstyles',	items : [ 'Bold','Italic','TextColor']},{ name:'styles', items:['Styles','Font','FontSize']}
	];
};

CKEDITOR.stylesSet.add('ProCSm',[
